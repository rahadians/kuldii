...
// import 'package:myproject/models/player.dart';
...
class Home_Page_State extends StatelessWidget {
  // const Home_Page_State({Key? key}) : super(key: key);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
              icon: Icon(Icons.remove_red_eye_outlined), //klik mata
              onPressed: () {
