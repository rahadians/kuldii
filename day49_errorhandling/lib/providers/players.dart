...
class Players with ChangeNotifier {
  ...
  addPlayer(String name, String position, String image) {
    ...
    Uri url = Uri.parse(
        "https://kuldii-http-req-default-rtdb.firebaseio.com/players");
    try {
      http
          .post(
        url,
  ...
  editPlayer(String id, String name, String position, String image) async {
    Uri url = Uri.parse(
        "https://kuldii-http-req-default-rtdb.firebaseio.com/players/$id.json");
    try {
  ...
  Future<void> initialData() async {
    Uri url = Uri.parse(
        "https://kuldii-http-req-default-rtdb.firebaseio.com/players.json");
